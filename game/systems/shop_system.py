...
class ShopSystem:
    ...
    def __init__(self, shops: Iterable[Dict[str, Any]], item_catalog: Dict[str, Item]) -> None:
    ...
    def _price(self, stock: Dict[str, Any]) -> Dict[str, int]:
        return currency.normalise_price(stock.get("price"))
